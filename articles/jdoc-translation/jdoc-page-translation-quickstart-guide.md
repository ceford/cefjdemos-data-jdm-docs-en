...
There is an alias to the word `Special:`, so you may also use just the
...
One thing to be aware of is that when translating a page, any 'category'
...
So you will have to translate **en** into your local language ID (in
